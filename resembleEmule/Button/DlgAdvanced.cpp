...
#define IDS_WEBADDR		_T("http://www.nudt.edu.cn")
...
BOOL CDlgAdvanced::OnInitDialog() 
{
	...
	m_btnBitmap1.AutoLoad(ID_BIPMAP_BUTTON,this);
...
{
	MessageBox(_T("第一个子菜单"), _T("按钮菜单"), MB_ICONINFORMATION);
} // End of OnItem1

void CDlgAdvanced::OnItem2() 
{
	MessageBox(_T("第二个子菜单"), _T("按钮菜单"), MB_ICONINFORMATION);
} // End of OnItem2
